...
[![GitHub Workflow Status (branch)](https://img.shields.io/github/actions/workflow/status/Tochemey/DotNetFreeSwitch/ci.yml?branch=trunk&style=flat-square)](https://github.com/Tochemey/ModFreeSwitch/actions/workflows/ci.yml)
