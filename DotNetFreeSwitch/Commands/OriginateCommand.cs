...
namespace DotNetFreeSwitch.Commands
{
   ...
   public sealed class OriginateCommand : BaseCommand
   {
      ...
      private readonly IList<ChannelVariable> _channelVariables;
          ...
          int timeout)
      {
         ...
         _timeout = timeout;
         _channelVariables = new List<ChannelVariable>();
      }
      ...
      public override string CommandName => "originate";
      ...
      public void SetChannelVariable(string variable,
          string value)
      {
         var var = new ChannelVariable(variable,
             value);
