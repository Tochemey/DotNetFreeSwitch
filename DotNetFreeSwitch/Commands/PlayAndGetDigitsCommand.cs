...
namespace DotNetFreeSwitch.Commands
{
   ...
   public sealed class PlayAndGetDigitsCommand : BaseCommand
   {
      ...
      protected override string Argument
      {
         ...
         {
            var argv =
                $"{MinNumberOfDigits} {MaxNumberOfDigits} {Retries} {Timeout} '{Terminators}' '{SoundFile}' {InvalidFile} {VariableName} {Regex} {DigitTimeout}";
            return argv;
         }
      }

      public override string CommandName => "play_and_get_digits";
