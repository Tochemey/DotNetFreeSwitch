...
namespace DotNetFreeSwitch.Handlers.inbound
{
   ...
   public abstract class InboundSession : IInboundListener
   {
      ...
      public void OnEventReceived(Message message)
      {
         ...
         var eslEvent = new Event(message);
         // grab the event name
         ...
         switch (eventType)
         {
            ...
            case EventType.CHANNEL_UNPARK:
               ...
               break;
            default:
               OnUnhandledEvents(new Event(message));
               break;
         }
      ...
      public bool CanHandleEvent(Event @event)
      {
      ...
      protected abstract Task HandleEvents(Event @event,
          EventType eventType);
      ...
      /// <returns></returns>
      protected virtual Task OnUnhandledEvents(Event fsEvent)
      {
